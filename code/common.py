...
AV_QUARANTINE_S3_PREFIX = os.getenv(
...
AV_STATUS_SNS_PUBLISH_INFECTED = os.getenv(
    "AV_STATUS_SNS_PUBLISH_INFECTED", "True")
AV_TIMESTAMP_METADATA = os.getenv("AV_TIMESTAMP_METADATA", "av-timestamp")
CLAMAVLIB_PATH = os.getenv("CLAMAVLIB_PATH", "/opt/python/bin")
CLAMSCAN_PATH = os.getenv("CLAMSCAN_PATH", "/opt/python/bin/clamscan")
FRESHCLAM_PATH = os.getenv("FRESHCLAM_PATH", "/opt/python/bin/freshclam")
